...
int
create_frame_list
(Display *display, struct Workspace_list* workspaces, char *workspace_name, struct Themes *themes, struct Cursors *cursors);

void remove_frame_list
(Display *display, struct Workspace_list* workspaces, int index, struct Themes *themes);
...
int
add_frame_to_workspace(Display *display, struct Workspace_list *workspaces, Window window, int *current_workspace
